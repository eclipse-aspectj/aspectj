...
=== [#details]#Details# of some compiler changes

==== [#WEAVE_TIME]#Compilation (weave) times reduced.#
...
==== [#INCREMENTAL]#Improvements to incremental compilation.#
...
==== [#ERROR_MESSAGES]#Improved error messages.#
...
==== [#REWEAVABLE]#The -Xreweavable option.#
...
==== [#COMPLIANCE]#The default compliance mode of the compiler has changed from -1.3 to -1.4.#
...
==== [#AJDOC]#The ajdoc tool makes a comeback in the AspectJ 1.2 distribution.#
...
==== [#LTW]#A sample script is supplied that supports load-time weaving from the command-line#
...
==== [#SOFTEX]#SoftException now supports getCause()#
...
==== [#LTW2]#org.aspectj.weaver.tools package added#
