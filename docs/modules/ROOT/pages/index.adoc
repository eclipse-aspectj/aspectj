...
|xref:faq:faq.adoc#faq[FAQ], xref:attachment$quickref/quick5.pdf[Quick Reference (AspectJ 5)],
xref:attachment$quickref/quick.pdf[Quick Reference (1.2.1)], xref:adk15notebook:index.adoc[AspectJ 5 Developer's Notebook],
...
link:weaver-api/index.html[weaver API] and xref:example$[example code]
...
|xref:attachment$quickref/quick5.pdf[AspectJ 5 Quick Reference]
|Four-page quick reference for the AspectJ 5 language

|xref:attachment$quickref/quick.pdf[AspectJ Quick Reference]
...
join point model and pointcuts, concepts AOP adds to OOP. To read about how the xref:example$[examples] work, see the
