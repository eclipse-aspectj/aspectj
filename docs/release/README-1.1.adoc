...
https://aspectj4emacs.sourceforge.net/[Emacs],
https://aspectj4netbean.sourceforge.net/[NetBeans] and
https://aspectj4jbuildr.sourceforge.net/[JBuilder] are now independent
